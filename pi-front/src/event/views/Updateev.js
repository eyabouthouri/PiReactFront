                    ...
                    <div className="iq-card-header d-flex justify-content-between">
                      <div className="iq-header-title">
                        <h4 className="card-title">
                          <i className="bi bi-file-earmark-person-fill"></i> update event
                        </h4>
                      </div>
                    </div>
                      ...
                      <form id="form-wizard1" classNameName="text-center mt-4" method="PUT" onSubmit={Handelsubmit}>
                        <div className="row align-items-center">
                          <div className="form-group col-sm-6">
                            <label htmlFor="title">
                              <i class="bi bi-clipboard"></i> title:
                            </label>
                          ...
                          <div className="form-group col-sm-6">
                            <label htmlFor="name">
                              <i className="bi bi-person-bounding-box"></i> organizer:
                            </label>
                          ...
                          <div className="form-group col-sm-6">
                            <label htmlFor="location">
                              <i class="bi bi-map-fill"></i> location:
                            </label>
