                    ...
                    <div className="iq-card">
                      <div className="iq-card-header d-flex justify-content-between">
                        <div className="iq-header-title">
                          <h4 className="card-title" ><i className="bi bi-file-earmark-person-fill"></i>  Add library</h4>
                        </div>
                      </div>
                        ...
                        <form id="form-wizard1" classNameName="text-center mt-4" method="POST" onSubmit={Handelsubmit}>
                          <div className="row align-items-center">
                            <div className="form-group col-sm-6">
                              <label htmlFor="name"><i className="bi bi-person-bounding-box"></i>  Name:</label>
                            ...
                            <div className="form-group col-sm-6">
                              <label htmlFor="tel"><i className="bi bi-person-bounding-box"></i>  Tel:</label>
                            ...
                            <div className="form-group col-sm-6">
                              <label htmlFor="country-select"><i className="bi bi-joystick"></i> pays:</label>                               
                              <select className="form-control" id="country-select" name="pays" placeholder='City' onChange={handleInputChange} value={state.pays} >
                            ...
                            <div className="form-group col-sm-6">
                              ...
                              <textarea type="text" className="form-control" name="location" placeholder="write your complete address please..." onChange={handleInputChange} value={state.location}/>
                              {!valid && msg.location && <span style={{ color: "red" }}>{msg.location}!! </span>}
                            </div>
                                        <div className="form-group col-sm-6">
                                           ...
                                           <input type="text" className="form-control" placeholder='exemple@exmpl.com'  name="email" onChange={handleInputChange}  value={state.email}/>
