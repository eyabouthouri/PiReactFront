                  ...
                  <div class="tab-pane fade active show" id="personal-information" role="tabpanel">
                    <div class="iq-card">
                      ...
                      <div class="iq-card-body">
                        <form id="form-wizard1" class="text-center mt-4" method="POST" onSubmit={Handelsubmit}>
                          <div class="row align-items-center">
                            <div class="form-group col-sm-6">
                              <label htmlFor="name"><i class="bi bi-person-bounding-box"></i>  Name:</label>
                              <input type="text" class="form-control" name="name" placeholder="name" onChange={handleInputChange} value={state.name}/>
                              {!valid && msg.name && <span style={{ color: "red" }}>{msg.name}!! </span>}
                            </div>
                            <div class="form-group col-sm-6">
                              <label htmlFor="tel"><i class="bi bi-person-bounding-box"></i>  Tel:</label>
                              <input type="text" class="form-control" name="tel" placeholder="tel" onChange={handleInputChange} value={state.tel}/>
                              {!valid && msg.tel && <span style={{ color: "red" }}>{msg.tel}!! </span>}
                            </div>
                            <div class="form-group col-sm-6">
                              <label htmlFor="country-select"><i class="bi bi-joystick"></i> pays:</label>                               
                            ...
                            <div class="form-group col-sm-6">
                              ...
                              <textarea type="text" class="form-control" name="adresse" placeholder="write your complete address please..." onChange={handleInputChange} value={state.adresse}/>
                              {!valid && msg.adresse && <span style={{ color: "red" }}>{msg.adresse}!! </span>}
                            </div>
                                        <div class="form-group col-sm-6">
                                           <label Htmlfor="email"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-at" viewBox="0 0 16 16">
                                           ...
                                           <input type="text" class="form-control" placeholder='exemple@exmpl.com'  name="email" onChange={handleInputChange}  value={state.email}/>
