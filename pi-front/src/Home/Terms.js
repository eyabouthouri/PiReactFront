...
function Terms() {
  ...
  return (
    <div>
      ...
      <p>You must not use our website in any way that causes, or may cause, damage to the website or impairment of the availability or accessibility of the website; or in any way which is unlawful, illegal, fraudulent or harmful.</p>
      <h4>6. Modifications to Terms and Conditions</h4>
      <p>We reserve the right to modify these terms and conditions at any time without notice. By using this website you are agreeing to be bound by the current version of these terms and conditions.</p>
      <br>
      </br>
      <br></br>
      <br></br>
