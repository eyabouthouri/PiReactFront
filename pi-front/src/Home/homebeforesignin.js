      ...
      <nav class="navbar navbar-expand-md navbar-light bg-light border-bottom shadow-sm">
        <div class="container">
          <a class="navbar-brand d-flex align-items-center">
            <img src="/images/yc.png" style={{ width: 150, height: 50 }} class=" navbar-light " height="30" width="50" alt="Tiya Golf Club" />
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <Link className="iq-sign-btn float-right" to="/Signin">
              Sign in
            </Link>
          </div>
        </div>
