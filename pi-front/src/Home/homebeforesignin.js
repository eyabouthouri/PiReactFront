            ...
            <div class="carousel-item active" style={{ backgroundImage: "url(home/assets/img/slide/R.jpg)" }}>
              <div class="carousel-container">
                <div class="container">
                  ...
                  <p class="animated fadeInDown">Join Youth-Connect, the ultimate platform for young people! 
Here, you can discover new events, take online courses, access libraries full of resources, and get mental health support.
 With our platform, you can take control of your future and achieve your goals.</p>
                    ...
                    {user &&
                      user.map((item, index) => {
                        return (
                          <div class="col-md-3">
                            <div class="member">
                              <img src={item.image} width={350} height={200}  alt="image2" />
